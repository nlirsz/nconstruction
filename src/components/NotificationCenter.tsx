...
export const NotificationCenter: React.FC<NotificationCenterProps> = ({ projects, onSelectProject, currentUser, iconClassName }) => {
                      ...
                      <div className="pl-2">
                        ...
                        {hasLink && (
                          <button 
                            ...
                            className="flex items-center gap-2 text-xs font-bold text-white bg-blue-600 hover:bg-blue-700 px-3 py-1.5 rounded-lg transition-colors w-full justify-center mt-2 shadow-sm"
                          >
                            <ExternalLink size={12} />
                            Ir para {linkedProjectName || 'Obra'}
                          </button>
                        )}
                      </div>
                    </div>
